...
import type { DelegateBudgetRouteSource, DelegateExtensionMode } from './delegate/types';
import type { FusionResultDetails, FusionUsage, FusionWorkflowId } from './fusion/types';
import type { BackgroundTaskChildProcess } from './registry';
...
export function rejectSurvivalForTaskKind(value: object, kind: string): void {
  if (!Object.hasOwn(value, 'surviveReload')) return;
